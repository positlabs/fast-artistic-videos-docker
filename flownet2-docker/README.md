...
Simply run `build.sh`. This will create two Docker images: The OS base (an Ubuntu 14.04 base extended by Nvidia, with CUDA 7.5), and the "flownet2" image on top. In total, about 8.5GB of space will be needed after building. Build times are a little slow.
